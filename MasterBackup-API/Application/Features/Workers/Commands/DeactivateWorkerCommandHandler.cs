...
public class DeactivateWorkerCommandHandler : IRequestHandler<DeactivateWorkerCommand, Unit>
{
    private readonly MasterDbContext _masterContext;
    private readonly ITenantContext _tenantContext;

    public DeactivateWorkerCommandHandler(
    ...
    public async Task<Unit> Handle(DeactivateWorkerCommand request, CancellationToken cancellationToken)
    {
